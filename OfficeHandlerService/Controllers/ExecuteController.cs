            ...
            try {
                ...
                if (response == null) {
                    ...
                    if (response == null) {
                        ...
                        return Content(HttpStatusCode.InternalServerError, "[ExecuteController/execute] Execution error: " + response);
                    }
                } else {
                    return Content(HttpStatusCode.InternalServerError, "[ExecuteController/execute] Parse error: " + response);
                }
            }catch (Exception ex) {
                return Content(HttpStatusCode.InternalServerError, "[ExecuteController/execute] " + ex.Message);
            }
        }
    }
}
